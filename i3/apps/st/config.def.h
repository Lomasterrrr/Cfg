 ...
 */
unsigned int defaultfg = 15;  // white text
unsigned int defaultbg = 0;   // black background
unsigned int defaultcs = 256; // cursor color (you can leave it as is, or set it to a color you prefer)
unsigned int defaultrcs = 257; // reverse cursor (you can leave it as is, or set it to a color you prefer)
